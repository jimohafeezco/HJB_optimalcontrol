...
legend('P1(k)', 'P2(k)')
saveas(gcf,[pwd '/imgQ13/PplotQ13'],'epsc')
...
legend('K1(t)', 'K1(ss)=',num2str(K(1,1)),'Location','southwest')
title(['Plot of feedback gain K1 with R=', num2str(R)])
c= num2str(K(1,1));
text(t(10), K(1,1)+0.05, c, 'Fontsize', 10);
saveas(gcf,[pwd '/imgQ13/GainplotQ13'],'epsc')
...
legend('K2(t)', 'K2(ss)','Location','southwest')
c= num2str(K(2,1));
text(t(10), K(2,1)+0.05, c, 'Fontsize', 10);

% legend( sprintf('K(t)'), sprintf('K(ss)', '%f2', K(2,1)))

xlabel('Time (sec)');ylabel('Gains')
saveas(gcf,[pwd '/imgQ13/Gain2plotQ13'],'epsc')
...
saveas(gcf,[pwd '/imgQ13/statesplotQ13'],'epsc')
...
saveas(gcf,[pwd '/imgQ13/XsplotQ13'],'epsc2')
...
legend('U(t)',"U(ss)")
saveas(gcf,[pwd '/imgQ13/inputplotQ13'],'epsc')
