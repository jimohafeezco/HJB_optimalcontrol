...
legend('P1(k)', 'P2(k)')
saveas(gcf,[pwd '/imgQ11/PplotQ11'],'epsc')
...
saveas(gcf,[pwd '/imgQ11/GainplotQ11'],'epsc')
...
xlabel('Time (sec)');ylabel('Gains')
saveas(gcf,[pwd '/imgQ11/Gain2plotQ11'],'epsc')
...
saveas(gcf,[pwd '/imgQ11/statesplotQ11'],'epsc')
...
saveas(gcf,[pwd '/imgQ11/XsplotQ11'],'epsc2')
...
legend('U(t)',"U(ss)")
saveas(gcf,[pwd '/imgQ11/inputplotQ11'],'epsc')
